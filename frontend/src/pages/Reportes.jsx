...
import ReporteEtiquetas from '../components/reports/ReporteEtiquetas';
...
const tabs = [
    ...
    { id: 'etiquetas', label: 'Etiquetas', icon: BookmarkIcon },
];
...
const Reportes = () => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'etiquetas': return <ReporteEtiquetas />;
                            ...
                            {tabs.map(tab => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`inline-flex items-center px-3 py-2 border-b-2 text-sm font-medium whitespace-nowrap transition-colors duration-200 ${
                                            isActive
