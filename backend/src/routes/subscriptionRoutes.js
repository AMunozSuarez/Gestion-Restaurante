 ...
 */
router.get('/:subscriptionId/history', authMiddleware, getPaymentHistory);
 ...
 */
router.put('/:subscriptionId/renew', authMiddleware, updateSubscription);

/**
 * PUT /api/subscriptions/:subscriptionId/upgrade
 * Cambiar el plan de una suscripción
 */
router.put('/:subscriptionId/upgrade', authMiddleware, upgradePlan);

/**
 * PUT /api/subscriptions/:subscriptionId/cancel
 * Cancelar una suscripción
 */
router.put('/:subscriptionId/cancel', authMiddleware, cancelSubscriptionHandler);
